...
<template>
  <div>
    <WelcomeItem>
      ...
      <i18n path="components.TheWelcome.documentation.message">
        <template #official>
    ...
    <WelcomeItem>
      ...
      <i18n path="components.TheWelcome.tooling.message">
        <template #vite>
    ...
    <WelcomeItem>
      ...
      <i18n path="components.TheWelcome.ecosystem.message">
        <template #state>
          <!-- eslint-disable-next-line @intlify/vue-i18n/no-raw-text -->
    ...
    <WelcomeItem>
      ...
      <i18n path="components.TheWelcome.community.message">
        <template #discord>
          <!-- eslint-disable-next-line @intlify/vue-i18n/no-raw-text -->
    ...
    <WelcomeItem>
      ...
      <i18n path="components.TheWelcome.support.message">
        <template #sponsor>
